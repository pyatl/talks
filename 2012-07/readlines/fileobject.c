...
file_readlines(PyFileObject *f, PyObject *args)
{
  /*
	##########################################
	THE HINT IS THE VALUE PROVIDED BY THE USER
	##########################################
  */
    long sizehint = 0;
    PyObject *list = NULL;
	...
	/*
	  #############################################
	  GET THE HINT VALUE PASSED IN FROM PYTHON PROG
	  #############################################
	*/
    ...
    for (;;) {
        if (shortread)
			...
			/*
			  ##################################
			  FILL THE BUFFER WITH LINES OF TEXT
			  AND TRACK THE NUMBER OF BYTES READ
			  ##################################
			*/
		...
		/*
		  #########################################
		  CHECK FOR AT LEAST ONE LINE IN THE BUFFER
		  AND READ MORE DATA IF NONE IS FOUND
		  #########################################
		*/
		...
		*/
		...
		/*
		  ##############################################
		  HAVE WE READ AS MUCH AS THE USER SAID TO READ?
		  ##############################################
		*/
        if (sizehint > 0)
